...
$(BINS): Main.cpp .lib/libMain.a
	$(NVC) -o $(BINS) $(CUDAFLAGS) $(DEFS) Main.cpp $(LDFLAGS);
...
archive:
	...
	dialog --inputbox "Please enter a description for this release of Eskilas source code :" 8 72 "<General Version>" 2>> COMMENT
